...
export default function OneK(){
    ...
    const makeList = () => {
        ...
        const list = [
            ...
            <Quiz question={`How many bridges cross the entirety of the River Thames?`} answer={`214`}/>,
            ...
            <Quiz question={`The actual name of the Houses of Parliament is the Palace of Westminster, but when were the current Houses of Parliament completed?`} answer={`1870`}/>,
